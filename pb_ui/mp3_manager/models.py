...
class Light(models.Model):
    ...
    randomise_brightness = models.BooleanField(blank=False, null=False,
                                            default=False)
    off = models.BooleanField(blank=False, null=False,
                              default=False)
...
class DiscoLight(models.Model):
    name = models.CharField(max_length=200, default="",
                          blank=False, null=False)
    pin_id = models.IntegerField(blank=False, null=False,
                                     default=0,
                                     validators=[MinValueValidator(0),
                                                 MaxValueValidator(40)])
    light_on = models.BooleanField(blank=False, null=False, default=True)
